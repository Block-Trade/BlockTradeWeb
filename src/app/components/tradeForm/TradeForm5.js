...
const TradeForm5 = ({history,setFinalBill,tradeDeal}) => {
    ...
    return (
        ...
        <div style={{ marginLeft: 'auto',marginRight:'auto' }}>
            <h3 style={{alignItems:"center"}}>Bill Details</h3>
            <form className={classes.root} noValidate autoComplete="off">
                <FormControl variant="outlined" className={classes.formControl}>
                    <InputLabel id="curr">Currency</InputLabel>
                    <Select name="curr" value={curr} onChange={(e) => setCurr(e.target.value)} label="Currency">
                    <MenuItem value="" disabled selected>Currency</MenuItem>
                ...
                <TextField
                    ...
                    type="text"
                    variant="outlined"
                    value={adjTotal} onChange={(e) => setAdjTotal(e.target.value)}
                />
                <TextField
                    id="devAmount"
                    label="Dev Amount"
                    type="text"
                    variant="outlined"
                    value={devAmount} onChange={(e) => setDevAmount(e.target.value)}
                />
                <TextField
                    id="packingChg"
                    ...
                    type="text"
                    variant="outlined"
                    value={packingChg} onChange={(e) => setPackingChg(e.target.value)}
                />
                <TextField
                    id="handChg"
                    ...
                    type="text"
                    variant="outlined"
                    value={handChg} onChange={(e) => setHandChg(e.target.value)}
                />
                <TextField
                    id="otherChg"
                    label="Other Charges"
                    type="text"
                    variant="outlined"
                    value={otherChg} onChange={(e) => setOtherChg(e.target.value)}
                />
                <TextField
                    id="insurAmount"
                    ...
                    type="text"
                    variant="outlined"
                    value={insurAmount} onChange={(e) => setInsurAmount(e.target.value)}
                />
                <TextField
                    id="taxAmount"
                    label="Tax Amount"
                ...
                <TextField
                    ...
                    type="text"
                    variant="outlined"
                    value={preTaxAmount} onChange={(e) => setPreTaxAmount(e.target.value)}
                />
                <TextField
                    id="tradeTotal"
                    label="Trade Total"
