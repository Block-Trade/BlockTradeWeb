...
const Kyc = ({ kycDl,kycPass, kyc, history }) => {
    ...
    return (
        ...
        {!toggler && <Card.Body style={{backgroundColor:"#2853C3"}}>
            
            <Button variant="light outline-dark" size="lg" onClick={e => {
                e.preventDefault();
                setMeth('dl');
                setToggler(true);
            }}>Kyc using DL</Button>
        ...
        <Form.Group className='d-flex search-field'>
            <select
                ...
                >
                <option disabled={true}>Country code</option>
            ...
            <Form.Control
                type='text'
                placeholder={meth == 'dl'? 'Driving License No.' : 'Passport No.'}
                size='lg'
                className='h-auto'
                value={no}
